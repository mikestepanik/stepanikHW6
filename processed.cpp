...
int main(int argc, char* argv[]){
 ...
 cout << "The FILE Path you will read from is: " << "/home/debian" << endl;
 ...
 string pathName = "/home/debian" + filename;
 ...
 string Write(argv[2]);
 string path("/home/debian/cpe422/stepanikHW6");
 fs1.open((path+"/"+ Write).c_str(), std::fstream::out);

 while(getline(fs,line)){
  fs1 << line << endl;
 }

 cout << "The FILE Path you will write to is: " << "/home/debian/cpe422/stepanikHW6" << endl;
 cout << "File name passed is: " << Write << endl;
